      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Post Events Link */}
            <Link href="/postevent">
              <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition cursor-pointer">
            ...
            <Link href="/events">
              <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition cursor-pointer">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">
                  Buy Tickets Online of Events
                </h3>
                <p className="text-gray-600">
                  Set up ticketing options, manage registrations, and process
                  payments securely within our platform.
                </p>
              </div>
            </Link>

            {/* Discover Local Events Link */}
            <Link href="/localevents">
              <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition cursor-pointer">
                ...
                <p className="text-gray-600">
                  Find exciting events happening near you with our advanced
      ...
      <section className="py-20 px-6 bg-purple-50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Discover why thousands of event organizers and attendees choose
              Evenza.
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-purple-700 text-white">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Post Your Next Event?
          </h2>
          <p className="text-lg text-purple-100 max-w-2xl mx-auto mb-8">
            Join thousands of event creators who trust Evenza for their event
            management needs.
          </p>
          <Link href="/login">
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Subscribe to our newsletter to get the latest updates on events and
            features.
          </p>
